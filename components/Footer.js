    ...
    <footer className="py-12 px-6 border-t border-gray-800">
      <div className="container mx-auto max-w-6xl">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          <div>
            <h3 className="text-2xl font-bold gradient-text mb-4">Nishanth Nuthi</h3>
            <p className="text-gray-400 text-sm leading-relaxed">
              Building digital experiences with modern technologies and creative problem-solving.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li>
                <a href="mailto:nishanthnuthi123@gmail.com" className="hover:text-indigo-400 transition-colors">
                  nishanthnuthi123@gmail.com
                </a>
              </li>
              <li>
                <a href="tel:+917013814085" className="hover:text-indigo-400 transition-colors">
                  +91 7013814085
                </a>
              </li>
        ...
        <div className="pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-sm text-gray-500">
            © {currentYear} Nishanth Nuthi. All rights reserved.
          </p>
